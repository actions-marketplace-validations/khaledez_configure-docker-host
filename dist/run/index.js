...
module.exports = eval("require")("./configure");
...
/* harmony import */ var _configure__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(335);



try {
	const privateKey = _actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput('ssh-private-key');
	...
	const sshUrl = await (0,_configure__WEBPACK_IMPORTED_MODULE_1__.configure)(privateKey, host, user, port);

	_actions_core__WEBPACK_IMPORTED_MODULE_0__.exportVariable('DOCKER_HOST', sshUrl);
	_actions_core__WEBPACK_IMPORTED_MODULE_0__.setOutput('ssh-url', sshUrl);
